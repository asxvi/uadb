...
def ni_gap_sweep(gap_sizes: list, max_ni: int = 10, max_n: int = 1000, step: int = 100, trigger_size: int = 10, reduce_to_size: int = 5):
...
def plot_ni_gap_sweep(max_ni: int, n: int, step: int, suite_name: str = None):
    ...
    # for trigger, reduce_to in red_params:
    #     experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, trigger, reduce_to))

    experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, step, 15, 10))
    experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, step, 10, 5))
    experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, step, 4, 2))
    experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, step, 9, 3))
    experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, step, 5, 2))
    experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, step, 3, 1))
    # experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, 1, 1))


## ============================== ##
# plot_ni_gap_sweep(10, 2000, 100, 'ni_gap_sweep_n2k')
...
def plot_ni_gap_sweep_dynamic(gap_sizes: list, ni_list: list, n_list: list, red_list: list, iv = 'gap_size', suite_name: str = None):
...
def plot_ni_gap_sweep2(max_ni: int, n_list: list, suite_name: str = None):
    ...
    experiments[suite_name].add(ni_gap_sweep2(gap_sizes, max_ni,n_list, 15, 10))
    experiments[suite_name].add(ni_gap_sweep2(gap_sizes, max_ni,n_list, 10, 5))
    experiments[suite_name].add(ni_gap_sweep2(gap_sizes, max_ni,n_list, 4, 2))
    experiments[suite_name].add(ni_gap_sweep2(gap_sizes, max_ni,n_list, 9, 3))
    experiments[suite_name].add(ni_gap_sweep2(gap_sizes, max_ni,n_list, 5, 2))
    experiments[suite_name].add(ni_gap_sweep2(gap_sizes, max_ni,n_list, 3, 1))
    # experiments[suite_name].add(ni_gap_sweep(gap_sizes, max_ni, n, 1, 1))


def ni_gap_sweep2(gap_sizes: list, max_ni: int = 10, n_list: list = [], trigger_size: int = 10, reduce_to_size: int = 5):
